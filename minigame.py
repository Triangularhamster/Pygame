...
game_over = font.render("Game Over", True, DONGGUK2)  # 게임 종료시 문구

# 게임 배경화면
background = pygame.image.load('C:\\Users\\HYUKJUN\\Documents\\TA\\programming_intro\\background1.png')  # 배경화면 사진 로드, 본인 파일 경로 지정하기
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        # 플레이어 사진 불러오기
        self.image = pygame.image.load('C:\\Users\\HYUKJUN\\Documents\\TA\\programming_intro\\chick_tall.png') # 본인 파일 경로 지정하기
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        # 적 사진 불러오기
        self.image = pygame.image.load('C:\\Users\\HYUKJUN\\Documents\\TA\\programming_intro\\boom2.png') # 본인 파일 경로 지정하기
        # 이미지 크기의 직사각형 모양 불러오기
        self.rect = self.image.get_rect()
        # rec 크기 축소(충돌판정 이미지에 맞추기 위함)
        self.rect = self.rect.inflate(-20,-20)
...
# 게임 BGM 설정
bgm = pygame.mixer.Sound('C:\\Users\\HYUKJUN\\Documents\\TA\\programming_intro\\backgroundMusic.mp3') # 본인 파일 경로 지정하기
bgm.play()
...
while True:
    ...
    scores = small_font.render("Score: " + str(SCORE), True, GRAY)
    ...
    if pygame.sprite.spritecollideany(P1, Enemies):
        ...
        # 플레이어
        GameDisplay.blit(background, (0, 0))
        image0 = pygame.image.load('C:\\Users\\HYUKJUN\\Documents\\TA\\programming_intro\\chickbommed_down.png') # 본인 파일 경로 지정하기
        image0.get_rect()
        GameDisplay.blit(image0, player_pos)

        # 폭탄
        image1 = pygame.image.load('C:\\Users\\HYUKJUN\\Documents\\TA\\programming_intro\\boomm_down.png') # 본인 파일 경로 지정하기
        image1.get_rect()
        ...
        bgm.stop()
        # 적과 충돌시 효과음 추가
        pygame.mixer.Sound('C:\\Users\\HYUKJUN\\Documents\\TA\\programming_intro\\BOOM.WAV').play() # 본인 파일 경로 지정하기
        time.sleep(0.5)
        # 게임오버화면 설정
        pygame.mixer.Sound('C:\\Users\\HYUKJUN\\Documents\\TA\\programming_intro\\gameover.mp3').play() # 본인 파일 경로 지정하기
        GameDisplay.fill(DONGGUK)
        final_scores = font.render("Your Score: " + str(SCORE), True, DONGGUK2)
        GameDisplay.blit(final_scores, (150, 100))
        GameDisplay.blit(game_over, (175, 200))
        time.sleep(1)
        pygame.display.update()
        time.sleep(5)
        pygame.quit()
